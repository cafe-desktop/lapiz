...
void		 lapiz_commands_load_uri		(PlumaWindow         *window,
							 const gchar         *uri,
							 const PlumaEncoding *encoding,
							 gint                 line_pos);

/* Ignore non-existing URIs */
gint		 lapiz_commands_load_uris		(PlumaWindow         *window,
							 const GSList        *uris,
							 const PlumaEncoding *encoding,
							 gint                 line_pos);

void		 lapiz_commands_save_document		(PlumaWindow         *window,
                                                         PlumaDocument       *document);

void		 lapiz_commands_save_all_documents 	(PlumaWindow         *window);
...
gint		_lapiz_cmd_load_files_from_prompt	(PlumaWindow         *window,
							 GSList              *files,
							 const PlumaEncoding *encoding,
							 gint                 line_pos);
...
void		_lapiz_cmd_file_close_tab 		(PlumaTab    *tab,
							 PlumaWindow *window);

void		_lapiz_cmd_file_save_documents_list	(PlumaWindow *window,
							 GList       *docs);
