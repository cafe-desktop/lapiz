...
static void
lapiz_docinfo_plugin_activate (BeanActivatable *activatable)
{
	LapizDocInfoPlugin *plugin;
	LapizDocInfoPluginPrivate *data;
	LapizWindow *window;
...
static void
lapiz_docinfo_plugin_deactivate (BeanActivatable *activatable)
{
	LapizDocInfoPluginPrivate *data;
	LapizWindow *window;
	CtkUIManager *manager;
...
static void
lapiz_docinfo_plugin_update_state (BeanActivatable *activatable)
{
	lapiz_debug (DEBUG_PLUGINS);
