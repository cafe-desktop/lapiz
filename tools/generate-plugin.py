...
# generate-plugin.py - lapiz plugin skeletton generator
...
HELP = USAGE + """
generate skeleton source tree for a new lapiz plugin.
...
output_files = {
    ...
    'lapiz-plugin.desktop.in': '%s/%s.lapiz-plugin.desktop.in' % (plugin_module, plugin_module)
}

if options['language'] == 'c':
    output_files['lapiz-plugin.c'] = '%s/%s-plugin.c' % (plugin_module, plugin_module)
    output_files['lapiz-plugin.h'] = '%s/%s-plugin.h' % (plugin_module, plugin_module)
else:
